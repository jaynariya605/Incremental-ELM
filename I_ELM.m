function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy] = i_elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
